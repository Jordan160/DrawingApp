   ...
   public boolean onOptionsItemSelected(MenuItem item) {
      ...
      switch (item.getItemId()) {
         case R.id.background_color:
            ...
            backgroundColor.show(getFragmentManager(), "background color dialog");
            return true; // consume the menu event
         case R.id.background_image:
            BackgroundImageSVFragment backgroundFragment = new BackgroundImageSVFragment();
            backgroundFragment.show(getFragmentManager(), "background image dialog");
            return true; // consume the menu event
         case R.id.color:
